...
const defineRelationships = () => {
  // Material to Manufacturer relationship
  ...
  // Crate to manufacturer relationship
  Crate.belongsTo(Manufacturer, {
    foreignKey: 'manufacturerId',
    as: 'manufacturer',
  })
  Manufacturer.hasMany(Crate, { foreignKey: 'manufacturerId', as: 'crates' })
  ...
  // Shipment to Manufacturer relationship
  Shipment.belongsTo(Manufacturer, {
    foreignKey: 'manufacturerId',
    as: 'manufacturer',
  })
