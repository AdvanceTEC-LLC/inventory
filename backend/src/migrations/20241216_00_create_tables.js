...
export const down = async ({ context: queryInterface }) => {
  ...
  try {
    ...
    await queryInterface.dropTable('shipment_crates', {
      cascade: true,
      transaction,
    })
    ...
    await queryInterface.dropTable('crates', { cascade: true, transaction })
    await queryInterface.dropTable('stock', { cascade: true, transaction })
    await queryInterface.dropTable('shipments', { cascade: true, transaction })
    await queryInterface.dropTable('requests', { cascade: true, transaction })
    await queryInterface.dropTable('projects', { cascade: true, transaction })
    await queryInterface.dropTable('materials', { cascade: true, transaction })
    await queryInterface.dropTable('vendors', { cascade: true, transaction })
    await queryInterface.dropTable('storages', { cascade: true, transaction })
